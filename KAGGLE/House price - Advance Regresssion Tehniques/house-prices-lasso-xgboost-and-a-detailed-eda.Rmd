...
```{r}
train <- read.csv("C:/Users/IT/Documents/Github/R_PRACTICE/KAGGLE/House price - Advance Regresssion Tehniques/train.csv", stringsAsFactors = F)
test <- read.csv("C:/Users/IT/Documents/Github/R_PRACTICE/KAGGLE/House price - Advance Regresssion Tehniques/test.csv", stringsAsFactors = F)
```
