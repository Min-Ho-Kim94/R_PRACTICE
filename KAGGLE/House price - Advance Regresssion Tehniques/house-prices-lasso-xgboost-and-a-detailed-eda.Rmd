...
```{r}
train <- read.csv("C:/Users/user/Documents/Github/R_PRACTICE/KAGGLE/House price - Advance Regresssion Tehniques/train.csv", stringsAsFactors = F)
test <- read.csv("C:/Users/user/Documents/Github/R_PRACTICE/KAGGLE/House price - Advance Regresssion Tehniques/test.csv", stringsAsFactors = F)
```
